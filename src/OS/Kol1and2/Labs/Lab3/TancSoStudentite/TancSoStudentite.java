package OS.Kol1and2.Labs.Lab3.TancSoStudentite;
...
public class TancSoStudentite {
    ...
    static Semaphore dressRoomM;
    static Semaphore dressRoomW;

    static Semaphore spotToDance;

    static Semaphore readyM;
    static Semaphore readyW;
    ...
    public void init() {
        ...
        dressRoomM = new Semaphore(10);
        dressRoomW = new Semaphore(10);
        spotToDance = new Semaphore(3);
        readyM = new Semaphore(0);
        readyW = new Semaphore(0);
    }
